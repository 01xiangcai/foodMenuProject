  ...
  <view class="page" :style="{ background: themeConfig.bgPrimary }">
    ...
    <view class="navbar" :style="{ background: scrollTop > 50 ? themeConfig.bgSecondary : 'transparent' }">
      <view class="navbar-content">
        <view class="back-btn" @tap="goBack" :style="{ background: scrollTop > 50 ? 'transparent' : 'rgba(0,0,0,0.3)' }">
          <text class="icon" :style="{ color: scrollTop > 50 ? themeConfig.textPrimary : '#fff' }">←</text>
        </view>
      ...
      <view class="form-container" :style="{ background: themeConfig.bgSecondary }">
        ...
        <view class="cell-group">
          ...
          >
            <view class="cell-item" hover-class="cell-hover">
              ...
              <view class="cell-right">
                <text class="cell-value" :class="{ empty: !formData.tags }" :style="{ color: formData.tags ? themeConfig.textSecondary : themeConfig.textTertiary }">
                  {{ formData.tags || '请选择标签' }}
                </text>
                <text class="cell-arrow" :style="{ color: themeConfig.textTertiary }">></text>
              </view>
        ...
        <view class="rich-input-group">
          <view class="rich-header">
            <text class="cell-icon">📝</text>
            <text class="cell-label" :style="{ color: themeConfig.textPrimary }">家庭备注 (多行)</text>
          </view>
...
const onCuisineChange = (e) => {
  cuisineIndex.value = e.detail.value
  formData.value.tags = cuisineOptions.value[e.detail.value]
}
