...
public class RateLimiterAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 获取注解
        com.yao.food_menu.common.annotation.RateLimiter rateLimiterAnnotation = method
                .getAnnotation(com.yao.food_menu.common.annotation.RateLimiter.class);
